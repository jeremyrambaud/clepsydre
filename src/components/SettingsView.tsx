        ...
        <div className="divide-y divide-border">
          <div className="py-4 first:pt-0">
            <div className="grid grid-cols-1 md:grid-cols-2 md:divide-x divide-border">
              ...
              <div className="space-y-2 border-t border-border pt-4 md:border-t-0 md:pt-0 md:pl-4">
                <label className="text-xs font-medium tracking-wide text-muted-foreground uppercase font-heading">
                  {t("settings.apiKey")}
                </label>
          ...
          <div className="py-4">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-medium text-foreground">{t("settings.autoSyncInterval")}</p>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-5 gap-4">
        <section className="xl:col-span-3 rounded-xl bg-card border border-border p-4 sm:p-6 space-y-5">
          <div className="flex items-center gap-2 mb-6">
            ...
            <h3 className="text-lg font-semibold font-heading text-foreground">{t("settings.automation")}</h3>
          </div>
