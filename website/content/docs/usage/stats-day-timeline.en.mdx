...
<Callout type="info">
The day timeline and the [timer timeline](/en/docs/utilisation/timer-timeline) act on the same Redmine entries: a change made on one side appears on the other after synchronization.
</Callout>
